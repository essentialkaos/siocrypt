...
all: siocrypt ## Build all binaries

siocrypt:
	@echo "[36;1mBuilding siocrypt…[0m"
	@go build $(VERBOSE_FLAG) -ldflags="-X main.gitrev=$(GITREV)" siocrypt.go

install: ## Install all binaries
	@echo "[36;1mInstalling binaries…[0m"
	@cp siocrypt /usr/bin/siocrypt

uninstall: ## Uninstall all binaries
	@echo "[36;1mRemoving installed binaries…[0m"
	@rm -f /usr/bin/siocrypt
